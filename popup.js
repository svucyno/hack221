...
(function () {
          ...
          () => {
            chrome.tabs.sendMessage(activeTab.id, { action: "extractProfile" }, async (response) => {
              ...
              if (data.skills && data.skills.length < 3) {
                 ...
                 alert('Few skills found automatically. Please review and add more skills before analyzing.');
                 return;
              }
  ...
  async function fetchRecommendations(data) {
    ...
    console.warn("Calling exact URL: http://localhost:8000/recommend with payload:", payload);
    ...
    try {
      ...
      console.warn("Backend down or timeout, exact error:", err.message, ". Falling back to JS recommender...");
